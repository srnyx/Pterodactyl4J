...
/**
 * Indicates that P4J encountered a Throwable while attempting to retrieve the WebSocket token for a server.
 */
public class TokenRetrievalFailureEvent extends ConnectionEvent {

	private final Throwable throwable;

	public TokenRetrievalFailureEvent(
			PteroClientImpl api,
			ClientServer server,
